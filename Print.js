  ...
  var PrintDijit = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    _getLayerTemplatesInfo: function() {
      ...
      if (pos > -1) {
        ...
        //**********************************************************************
        url = "http://geocatminapp.ingemmet.gob.pe/arcgis/rest/services/temp/getLayoutTemplate/GPServer/getLayoutTemplate/execute";
        //**********************************************************************
        esriRequest({
          url: url,
          content: {
    ...
    _handlePrintInfo: function(rData) {
      if (!rData.isGPPrint) {
        ...
        // ************************************************************************
        Layout_Template[0].choiceList = this.templateNames;
        // ************************************************************************
        ...
        // ************************************************************************
        Format[0].choiceList = this.listFormat;
        // ************************************************************************
